...
public class NioClient implements Runnable {
    ...
    // a worker thread that is in charge of sending data to the server
    ...
    public void sendMessage(byte[] data, RspHandler handler){
        dataSendThread.fillData(data, handler);
    }
