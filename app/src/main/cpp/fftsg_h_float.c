...
void ddst(int n, int isgn, float *a)
{
    ...
    void rftfsub(int n, float *a);
    void rftbsub(int n, float *a);
    void dstsub(int n, float *a);
    void dstsub4(int n, float *a);
    int j;
    float xr;
...
{
    void ddct(int n, int isgn, float *a);
    void bitrv1(int n, float *a);
    int j, k, m, mh;
    float xr, xi, yr, yi, an;
